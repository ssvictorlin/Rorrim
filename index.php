...
<body>
	...
	<div class="toggle3" style="display:none;width:100%;height:100%;position:absolute;"></div>
	...
	<canvas id="canvas" width="1200px" height="1751px" ></canvas>
    ...
    <div align="right" hidden id="camera" ><img src="img/camera_w.png"; /></div>
    <div align="left" hidden id="home" ><img src="img/home_w.png"; /></div>
    <div align="left" hidden id="phone" ><img src="img/phone_w.png"; /></div>
    <div align="right" hidden id="youtube" ><img src="img/youtube_w.png"; /></div>
